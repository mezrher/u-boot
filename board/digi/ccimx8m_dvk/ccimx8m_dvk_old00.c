...
static void enet_device_phy_reset(void)
{
	/*  
		...
		low to maintain the phy deactivated until power supply AVDDH (3v3_core) is stable.
		The Reset in our Design is done by hardware without GPIO interraction
		-> here power generated by mca regulator BUCK4 come up directly after SOM is on-> see Power sequence
		-> when VDD_ENET (1v8) is up then reset is deasserted automatically -> Phy aktiv 
...
int board_phy_config(struct phy_device *phydev)
{
	...
	//Read and write is done through ksz9031_phy_extended_read and ksz9031_phy_extended_write
	int tmp;
...
static int setup_fec(void)
{
		...
		/*  CCM Clock controller Module Datasheet page 1307 iMx 8M Nano ->
		    3034_0004 General Purpose Register 1 (IOMUXC_GPR_GPR1)
		    PIN13 in IOMUXC_GPR_GPR1 with name: GPR_ENET1_TX_CLK_SEL -> This bit works as direction control of ENET_TD2.ALT1.
		    0 ENET_TD2.ALT1 is input, input data is used as ENET1_IPG_CLK_RMII (ENET1_TX_CLK)
		    1 ENET_TD2.ALT1 is output, output data comes from CCM_ENET_REF_CLK_ROOT.
		    imx-regs-imx8mm.h:#define IOMUXC_GPR_GPR1_GPR_ENET1_TX_CLK_SEL_MASK 0x2000u
		    arch/arm/include/asm/io.h:#define clrsetbits_le32(addr, clear, set) clrsetbits(le32, addr, clear, set)
...
//@Mezrher
	...
	//setbits_le32(&iomuxc_gpr_regs->gpr[1],BIT(13));
	//return 0;
